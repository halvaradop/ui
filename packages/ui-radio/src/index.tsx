...
export const Radio = ({
    ...
    ref,
    ...props
}: RadioProps<typeof radioVariants & typeof internalVariants>) => {
    return (
        <label className="w-min inline-flex items-center justify-center relative hover:cursor-pointer" htmlFor={name}>
            <input
